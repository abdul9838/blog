...
const navItemsInfo = [
  ...
  { name: "Blog", type: "link", href: "/blog/1" },
  {
    name: "Pages",
    type: "dropdown",
    items: [
    ...
    <li className="relative group">
      {item.type === "link" ? (
        <>
          ...
          <span className="cursor-pointer text-blue-500 absolute transition-all duration-500 font-bold right-4 top-0 group-hover:right-[66%] opacity-0 group-hover:opacity-100">
            _
          </span>
        </>
      ) : (
